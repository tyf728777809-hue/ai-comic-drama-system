...
| 输入 | 路径 | 用途 |
|------|------|------|
| 当前最新剧本 | `project_data/episodes/epXX/script-vX.yaml` | 定稿整理的基准 |
| 故事梗概 | `project_data/series/synopsis-vX.yaml` | 复盘参考 |
| 分集规划 | `project_data/series/episode-plan-vX.yaml` | 复盘参考 |
...
| 产物 | 输出路径 | 说明 |
|------|---------|------|
| 正式剧本文件 | `project_data/episodes/epXX/script-vX.yaml` | 按模板整理的定稿版本 |
| 确认前复盘摘要 | `project_data/episodes/epXX/review-summary-vX.yaml` | 给用户确认的摘要 |
| 生产规划交接摘要 | `project_data/episodes/epXX/handoff-script-to-planning-vX.yaml` | 给生产规划阶段的交接 |
...
读取 `project_data/episodes/epXX/` 下的最新剧本文件。
确认当前版本号和 status。
...
将复盘摘要写入 `project_data/episodes/epXX/review-summary-vX.yaml`。
...
将交接摘要写入 `project_data/episodes/epXX/handoff-script-to-planning-vX.yaml`。
