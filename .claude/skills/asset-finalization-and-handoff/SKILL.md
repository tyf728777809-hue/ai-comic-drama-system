...
| 输入 | 路径 | 用途 |
|------|------|------|
| 当前资产清单 | `project_data/episodes/epXX/asset-manifest-vX.yaml` | 定稿整理的基准 |
| 当前 prompt 文件 | `project_data/episodes/epXX/asset-prompts-vX.yaml` | 定稿参考 |
| 图片生成结果 | `project_data/episodes/epXX/assets/images/` | 归档整理 |
...
| 产物 | 输出路径 | 说明 |
|------|---------|------|
| 正式资产索引 | `project_data/episodes/epXX/asset-index-vX.yaml` | 资产总索引 |
| 正式资产结果归档 | `project_data/episodes/epXX/asset-archive-vX.yaml` | 生成结果归档 |
| 确认前复盘摘要 | `project_data/episodes/epXX/asset-review-summary-vX.yaml` | 给用户确认 |
| 视频生产交接摘要 | `project_data/episodes/epXX/handoff-asset-to-video-vX.yaml` | 给视频阶段 |
...
读取 `project_data/episodes/epXX/` 下的最新资产清单和 prompt 文件。
读取已生成的图片结果目录。
确认当前版本号和 status。
