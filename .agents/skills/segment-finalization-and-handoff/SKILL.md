...
| 输出项 | 文件 | 说明 |
|--------|------|------|
| 正式 segment 总表 | `project_data/projects/{project_id}/episodes/epXX/segments/segments-v{version}.yaml` | 所有 segment 概览 |
| 正式单段任务文件 | `project_data/projects/{project_id}/episodes/epXX/segments/tasks/{episode_id}-SEG{NN}-v{version}.yaml` | 每个 segment 详细任务 |
| 确认前复盘摘要 | `project_data/projects/{project_id}/episodes/epXX/segments/planning-review-summary-v{version}.yaml` | 面向用户的确认材料 |
| 资产生产阶段交接摘要 | `project_data/projects/{project_id}/episodes/epXX/segments/handoff-script-to-planning-v{version}.yaml` | 面向资产生产阶段的交接 |
