...
| 字段 | 来源 | 填写规则 |
|------|------|---------|
| 角色外观 | creative-bible → visual_keywords | 必须包含：发色、发型、肤色、体型、年龄感 |
| 服装 | creative-bible + segment 任务 | 必须与已锁定设定一致 |
| 标志物 | creative-bible → visual_keywords | 配饰、纹身、疤痕等 |
...
| 画风流派 | creative-bible → visual_style | 全局统一的画风关键词 |
| 色彩方案 | creative-bible → color_palette | 全局统一的色彩关键词 |
...
| 风格是否与全局一致 | 画风和色彩与 creative-bible 一致 | fail |
